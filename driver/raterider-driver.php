			...
			<div class="phone-box wrap push" id="home">
				<div class="menu-notify">
					...
					<div class="Profile-mid">
						<h5 class="pro-link" id="on-offline"><a>RATE</a></h5>
					</div>
					<!--
				...
				<div class="row">
					...
					<div class="panel">
						<div style="text-align:center;margin-bottom:20px;margin-top:20px;">
							<h2 style="color:white; display:inline;"><span class="glyphicon glyphicon-star" aria-hidden="true" style="color:yellow;"></span></h2>
							<h2 style="color:white; display:inline;"><span class="glyphicon glyphicon-star" aria-hidden="true" style="color:yellow;"></span></h2>
							<h2 style="color:white; display:inline;"><span class="glyphicon glyphicon-star" aria-hidden="true" style="color:yellow;"></span></h2>
							<h2 style="color:white; display:inline;"><span class="glyphicon glyphicon-star" aria-hidden="true" style="color:yellow;"></span></h2>
							<h2 style="color:white; display:inline;"><span class="glyphicon glyphicon-star" aria-hidden="true" style="color:yellow;"></span></h2>
					...
					<a href="home-driver.php">
						<div class="panel text-center" style="background-color: green; color: white; padding-left:15px;padding-top:15px;padding-bottom:17px;">
							<h5>COMPLETE RATING</h5>
						</div>	
					</a>
				</div>
