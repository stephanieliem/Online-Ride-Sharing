				...
				<div class="login-form" style="height: 100%;">
					<form action="login.php" method="post">
						...
						<div class="wthree-text"> 
							...
							<label for="brand1" style="text-align:left;"><span></span>I accept the terms of use</label> 
						</div>
						<input type="submit" value="Sign Up" style="background-color:#2A3F54">			
					</form>
					<p>Already have an account ?<a href="login.php"  style="color:#2A3F54"> Sign In</a></p>
				</div> 
			</div>
		</div>
	</div>					
