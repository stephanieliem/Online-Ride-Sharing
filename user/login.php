		...
		<div>
			<div style="height: 1200px;"> 	
				<div class="booking-info">
				   <h3 style="padding-top: 12px; color:#2A3F54">PICK ME UP!</h3>
					
				</div>
				<div class="login-form" style="height: 100%;">
					<form action="map-user.php" method="post">
						<p>User Name </p>
						...
						<div class="wthree-text"> 
							<ul> 
								<li>
									<input type="checkbox" id="brand" value="" style="border: 2px solid #2A3F54">
						...
						<input type="submit" value="Sign In" style="background-color: #2A3F54">
					</form>
					<p>Dont have an account ?<a href="register.php" style="color:#2A3F54"> Sign Up</a></p>
				</div> 
			</div>
		</div>
	</div>					
